...
An Android app that lets you use Instagram and TikTok on your own terms. It opens their mobile websites
inside the app, removes the parts designed to keep you scrolling (ads, suggested posts, Reels, the For You
feed, the endless feed after "you're all caught up"), measures how you actually use it, and turns those
numbers into a short, personal habit summary with an AI.
...
| **Apps** | The platforms. Instagram and TikTok are live; YouTube, Facebook and LinkedIn are shown faded as "coming soon". |
...
- **Time:** counted while an app's screen is in the foreground inside InnerCircle, using the phone's
  ...
  Wall-clock time only decides which day and hour it belongs to. Time in Instagram or TikTok *outside*
  InnerCircle is not counted.
...
- **YouTube, Facebook and LinkedIn are still placeholders.**
